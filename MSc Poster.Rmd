...
1.  Determine whether there is a difference in EEG signals of shizophrenics vs controls
...
Our data were taken from the National Institute of Mental Health (NIMH project number R01MH058262), available from [www.kaggle.com/datasets/broach/button-tone-sz/data ](https://www.kaggle.com/datasets/broach/button-tone-sz/data)
...
-   Variable discombobulation [^2]
-   Expand our minds with explosive machine learning [^3].

[^2]: Massey et al. 2005 doi: 15.36.413

[^3]: Smith et al. 1991 doi: 12.36.486
