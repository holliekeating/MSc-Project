...
• Figures \@ref(fig:fig5) and \@ref(fig:fig6) show less significant differences between case and control for conditions 2 & 3 respectively.
This indicates that both auditory and motor stimuli are required to stimulate an significant EEG response for those with schizophrenia. 
