...
```{r cartoon, echo = FALSE, out.width="50%", fig.cap = "EEG illustration[^2]"}

knitr::include_graphics("cartoon.jpg")

```

[^2]: Morozov 2023, Available at: https://www.istockphoto.com/vector/female-patient-do-eeg-scan-in-clinic-gm1474307021-504208695
...
```{r button, echo = FALSE, out.width="80%", fig.cap = "Condition Visualisation"}
...
- ***Why FP1?:*** Previous EEG studies reported altered frontal activity and reduced frontal coherence in relation to schizophrenia research. [^3]

[^3]: Tauscher 1998, doi: 10.1016/S0006-3223(97)00428-9

```{r fig1, echo = FALSE, out.width="40%", fig.cap = "Nodes Cap[^5]"}

knitr::include_graphics("nodes.png")

```
[^5]: Kuo-Song Chang 2022, doi: 10.1371/journal.pone.0275870
...
```{r fig2, echo = FALSE, out.width = '75%', fig.cap = "Raw Data Plot, Condition 1: Cases vs Controls"}
...
-   Figure \@ref(fig:fig4) shows an approximate significant difference between cases and controls following 400 ms.
...
```{r fig6, echo = FALSE, out.width = '90%', fig.cap = "Permutation T Test Plot, Condition 3: Cases vs Controls"}
knitr::include_graphics('cond3_permt1.png')
```
-   Figures \@ref(fig:fig5) and \@ref(fig:fig6) show less significant differences for Conditions 2 and 3.
...
We will use the `fdapace` and `fda` packages [^4] for this.
