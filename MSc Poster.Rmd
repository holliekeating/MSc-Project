...
Our hypothesis is proven visually by the Figures produced by our t-test. • In Figure \@ref(fig:fig4), we see a statistically significant difference around N400 which approximately increases on average as time increases. • Figures \@ref(fig:fig5) and \@ref(fig:fig6) show less significant differences between case and control for conditions 2 & 3 respectively. This indicates that both auditory and motor stimuli are required to stimulate an significant EEG response for those with schizophrenia.
