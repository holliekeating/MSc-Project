...
```{r button, echo = FALSE, out.width="40%", fig.cap = "Condition Visualisation"}
...
```{r fig1, echo = FALSE, out.width="55%", fig.cap = "Nodes Cap"}
...
Our hypothesis is proven visually by the Figures produced by our t-test. This suggests that combined auditory and motor stimulation is required to trigger a significant EEG response in schizophrenia.
