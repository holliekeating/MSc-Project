...
Previous studies have investigated schizophrenia using EEG data to identify abnormalities in sensory processing and sensory gating (e.g. @BOUTROS2009, @Shen2020). Many analyses have focused on specific EEG features, such as amplitudes and latencies at predefined regions of the signal, while others have applied machine learning (ML) methods to extracted EEG features. It is clear that these approaches create valuable insights, however, information is often discarded contained within the full EEG trajectory. Recent research has suggested that differences in schizophrenia may be reflected not only in average EEG responses, but also in variability between repeated trials. Karanikolaou et al. [-@Karanikolaou2022] found evidence of imprecise results while analysing temporal EEG activity for individuals with schizophrenia, suggesting that between-trial variation may contain important information about EEG prediction mechanisms. This highlights the importance of methods that account for repeated measurements when analysing EEG data. 
...
For Level 2, above, the first principal component displays the dominant source of between-trial variation within subjects. As expected, less localised variation is observed than between-subject variation. However, the magnitude of the deviations from the mean function suggests that a lot of variability exists between repeated trials despite accounting for subject-level effects. As before, the second and third Level 2 components describe additional within-subject fluctuations. 
