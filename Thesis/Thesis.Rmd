...
```{r, echo = FALSE, fig.show='hold', out.width="49%", fig.width = 15, fig.height="80%", fig.asp = 0.9, fig.cap = "Plots of raw and smoothed data, coloured by case-control status", fig.pos="H"}
...
```{r, echo=FALSE, fig.show='hold', out.width="49%", fig.width = 18, fig.asp = 0.9, fig.cap="Curves with highest 5 FPC 1 scores (blue) and lowest 5 scores (red)", fig.pos="H"}
...
```{r, echo = FALSE, fig.show='hold', out.width="49%", fig.width = 18, fig.asp = 0.9, fig.cap="Visulisation of K-means clustering of FPC scores", fig.pos="H"}
