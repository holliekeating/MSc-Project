...
Strengths 
- incorporated multilevel repeated trials, using functional data analysis to treat EEG signals as continuous functions.

- successfully created a predictive model for schizophrenia using mfpca scores. Elastic net regression was a suitable choice to automatically perform variable selection, although evidence of overfitting remains

- consistent results, where several analyses identified Condition 1 as the most informative condition, including permutation tests and elastic net. 

Limitations
- small number of subjects following full split of dataset
- potential overfitting as many of the elastic net models retained a large number of predictors relative to the number of subjects
- only a subset of EEG nodes were analysed
...
- future work could use more participants
- could use a larger number of trials 
- could incorporate more nodes
- could apply FPCA to different nodes and conditions
