...
To determine whether the subject-level variation identified by MFPCA improved the distinction between cases and controls, k-means clustering was applied to MFPCA level 1 scores and compared with standard FPCA score clustering results. 

The elbow plot suggested that five clusters was a reasonable choice, therefore, k-means clustering was performed using five clusters based on the first four Level 1 MFPCA scores. 

*Insert Cluster Picture*

Visual inspection of the resulting clusters showed that, when compared with clustering based on standard FPCA scores, the MFPCA clusters appeared to provide a slightly clearer representation of between-subject variability. Level 1 scores account for the repeated-trial structure of the data, however show broadly similar results to that observed using standard FPCA scores at subject-level. 
...
- what do the fpcs tell us and what do the scores tell us about how much an individual eeg aligns with the eigenfunction?

### K-means Clustering

The k-means clusters indicate that there may be some predictive power in the FPC scores since cluster 1, 3, and 4 have membership mainly of cases or controls. Though there is some overlap in cluster 2.........
